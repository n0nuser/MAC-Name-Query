...
So basically this tools satisfies the curiosity of knowing the MAC Address via CLI.

Please, don't DDos [MACVendors Page](https://macvendors.com/) by creating huge MAC lists.

However, I'll modify the script so there can be more MACs and it doesn't overload the page.
